...
out={
 ...
 "ROLE":farm.get("domain","autonomous-experiment-orchestrator"),
 ...
 "PROVENANCE":{"repository":"dmaillot95-ui/cerebron-farm-68-autonomous-experiment-orchestrator","generated_at":datetime.datetime.now(datetime.timezone.utc).isoformat()},
